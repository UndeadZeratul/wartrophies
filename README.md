...
#### *There is a memory leak with dictionaries in GZDoom 4.3.3 and below! You will run out of memory if you play for too long! This has been reported and a fix is underway. If you are reading this, a fix does not yet exist.*
